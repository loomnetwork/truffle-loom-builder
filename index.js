...
function LoomBuilder(config, build_or_dist, extra_processors) {
  this.config = config;
...
LoomBuilder.prototype.setup = function(extra_processors) {
...
LoomBuilder.prototype.build = function(options, callback) {
...
LoomBuilder.prototype.process_file = function(file, callback) {
  var self = this;
...
LoomBuilder.prototype.process_files = function(files, base_path, separator, callback) {
  var self = this;
...
LoomBuilder.prototype.process_directory = function(target, callback) {
...
LoomBuilder.prototype.process_target = function(target, callback) {
  var self = this;
...
LoomBuilder.prototype.process_all_targets = function(callback) {
  var self = this;
...
LoomBuilder.prototype.expect = function(expected_path, description, extra, callback) {
